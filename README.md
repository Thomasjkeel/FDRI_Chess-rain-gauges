...
Across most of the catchment the difference between the two datasets (here bias) has increased towards HadUK-Grid.  
One exception is in the south east of the study region (where CEH bias has grown).   
Potentially, a rain gauge was added/removed towards the south-east that has only been included in the CEH-GEAR?  
